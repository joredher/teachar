...
//require('./bootstrap');
/*
window.jQuery  = window.$ = require('./core/libraries/jquery.min.js');
window.Tether = require('../vendors/js/ui/tether.min');
require('./core/libraries/bootstrap.min.js');

*/
window.toastr = __webpack_require__(2);
window.Vue = __webpack_require__(5);
__webpack_require__(7);
window.VeeValidate = __webpack_require__(9);
var es = __webpack_require__(10);
Vue.use(VeeValidate, { locale: 'es' });
window.VuePaginator = __webpack_require__(11);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function (a) {
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (a) {
    return function () {
      function h(a, b, c) {
